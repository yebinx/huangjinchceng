...
import EventCenter from '../../resources/script/network/netData/EventCenter';
...
export class GameCtrl extends Component {
    ...
    protected onDestroy(): void {
        // EventCenter.getIns().off("betResultErr",this.betResultErr,this)
    }
    ...
    private register(){
        ...
        // EventCenter.getIns().on("betResultErr",this.betResultErr,this)
    }
    ...
    // private betResultErr(code:number){
